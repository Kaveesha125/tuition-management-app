...
public class AdminHomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView btnManageTeachers = view.findViewById(R.id.btnManageTeachers); // ✅ Teacher button
        ...
        btnManageTeachers.setOnClickListener(v -> {
            Intent intent = new Intent(getActivity(), ManageTeachersActivity.class); // ✅ Launch teacher screen
            startActivity(intent);
        });
    }
}